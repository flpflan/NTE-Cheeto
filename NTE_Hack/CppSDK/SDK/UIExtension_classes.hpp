...
public:
	...
	TArray<TSubclassOf<class UObject>>            DataClasses;                                       // 0x0270(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	...
	TMap<struct FUIExtensionHandle, class UUserWidget*> ExtensionMapping;                            // 0x02B0(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TMap<struct FUIExtensionHandle, class UUserWidget*> NeedMetadataMapping;                         // 0x0300(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
