...
{
public:
	class USmartObjectComponent*                  SOComponent;                                       // 0x02C8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	TArray<class USmartObjectDefinition*>         Definitions;                                       // 0x0360(0x0010)(Edit, ZeroConstructor, EditConst, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
class SDK_ALIGN(0x10) USmartObjectComponent : public USceneComponent
{
public:
...
{
public:
	class USmartObjectSubsystemRenderingComponent* RenderingComponent;                               // 0x02C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	TArray<class USmartObjectTest*>               Tests;                                             // 0x02C8(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	class USmartObjectTestRenderingComponent*     RenderingComponent;                                // 0x02D8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class USmartObjectSubsystem*                  SmartObjectSubsystem;                              // 0x02E0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
