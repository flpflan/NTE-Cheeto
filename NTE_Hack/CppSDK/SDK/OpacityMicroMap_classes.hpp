...
{
public:
	TMap<uint64, class UOpacityMicroMapData*>     Collection;                                        // 0x0028(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UOpacityMicroMapCollection*             Collection;                                        // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
